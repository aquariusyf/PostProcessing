...
for file in All_Ping_Results:
    ...
    print(datetime.now().strftime("%H:%M:%S"), '(Ping_SimResult_For_ADB) ' + 'File opened: ' + file)
    openedFile.close()
...
print(datetime.now().strftime("%H:%M:%S"), '(Ping_SimResult_For_ADB) ' + 'Result extracted: ' + savePath)
wb.save(savePath)